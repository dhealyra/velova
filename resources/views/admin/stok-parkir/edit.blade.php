...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{ route('stok-parkir.update', $stokParkir->id) }}" method="POST">
      @csrf
      @method('PUT')
      ...
      <div class="input-group input-group-merge mb-4">
        ...
        <div class="form-floating form-floating-outline">
          <input type="number" name="kapasitas" value="{{ old('kapasitas', $stokParkir->kapasitas) }}" class="form-control @error('kapasitas') is-invalid @enderror" id="kapasitas" placeholder="Kapasitas Kendaraan" />
      ...
      <div class="input-group input-group-merge mb-4">
        ...
        <div class="form-floating form-floating-outline">
          <input type="number" name="sisa_slot" value="{{ old('sisa_slot', $stokParkir->sisa_slot) }}" class="form-control @error('sisa_slot') is-invalid @enderror" id="sisa_slot" placeholder="Sisa Slot Tersedia" />
