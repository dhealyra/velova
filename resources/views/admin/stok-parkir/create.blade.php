...
<div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('admin.stok-parkir.store') }}" method="POST">
        @csrf
        ...
        <div class="input-group input-group-merge mb-4">
          ...
          <div class="form-floating form-floating-outline">
            <input type="number" name="kapasitas" value="{{ old('kapasitas') }}" class="form-control @error('kapasitas') is-invalid @enderror  px-3 py-2" id="kapasitas" placeholder="Kapasitas Kendaraan" />
