            ...
            <div class="authentication-inner py-6 mx-4">
                ...
                <div class="card p-sm-7 p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="#" class="app-brand-link gap-1 align-items-center d-flex">
                            <span class="app-brand-logo demo">
                                <span class="text-primary">
                                <img src="{{ asset('logo/logos.png') }}" class="img-fluid" style="height: 30px; margin-right: 0px;" alt="Logo">
                            </span>
                            </span>
                            <span class="app-brand-text demo text-heading fw-semibold" style="margin-top: 4px;">Velova</span>
                        </a>
                        </div>
                        ...
                        <form id="formAuthentication" class="mb-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-5 pb-2 d-flex justify-content-between pt-2 align-items-center">
                                <div class="form-check mb-0">
                                    ...
                                    <label class="form-check-label" name="remember" id="remember" for="remember-me"
